...
const SHEET_TABLE_MAP = {
  ...
  'For Whatsapp': { client: masterSupabase, table: 'whatsapp_logs', altTable: 'users' },
  'Records': { client: masterSupabase, table: 'whatsapp_logs', altTable: 'users' },
  'For Records': { client: masterSupabase, table: 'whatsapp_logs', altTable: 'users' },
